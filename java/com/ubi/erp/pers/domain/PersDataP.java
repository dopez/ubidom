...
public class PersDataP implements Serializable {
	...
	public PersDataP(String compId, String empNo, String korName,
			String engName, String chaName, String regiNumb, String eMail,
			String enterDate, String postCode, String postName, String jikwee,
			String jikchak, String disorderCont, String baseAddrs,
			String address, String tel, String handPhone, String character,
			String taste, String partCont, int length, int weight,
			String eyeLeft, String eyeRight, String blood, String bldKind,
			String armyKind, String amryBarch, String armyNo, String amryDate1,
			String amryDate2, String religion, String armyYn, String armyGd,
			String armyMerit, String eduDate1, String eduName,
			String specCode1, String eduDate2, String eduName2,
			String specCode1_2, String eduDate3, String eduName3,
			String specCode1_3, String eduDate4, String eduName4,
			String specCode1_4, String eduDate5, String eduName5,
			String specCode1_5, String eduDate6, String eduName6,
			String specCode1_6, String qualNmGd1, String achiDate1,
