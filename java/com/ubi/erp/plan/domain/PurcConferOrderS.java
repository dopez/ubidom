...
@Alias("PurcConferOrderS")
public class PurcConferOrderS implements Serializable{
	...
	public String getSettle1EmpName() {
		return settle1EmpName;
	}
	public void setSettle1EmpName(String settle1EmpName) {
		this.settle1EmpName = settle1EmpName;
	}
	public String getSettle2EmpName() {
		return settle2EmpName;
	}
	public void setSettle2EmpName(String settle2EmpName) {
		this.settle2EmpName = settle2EmpName;
	}
	public String getSettle3EmpName() {
		return settle3EmpName;
	}
	public void setSettle3EmpName(String settle3EmpName) {
		this.settle3EmpName = settle3EmpName;
	}
	public String getSettle4EmpName() {
		return settle4EmpName;
	}
	public void setSettle4EmpName(String settle4EmpName) {
		this.settle4EmpName = settle4EmpName;
	}
