    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                gridDtl.setHeader("계정,승인일자,전표일자,번호,거래처,적요,세목,차변,대변,잔액");
                gridDtl.attachFooter(",월계,#cspan,#cspan,#cspan,#cspan,#cspan,0,0,0");
                gridDtl.attachFooter(",누계,#cspan,#cspan,#cspan,#cspan,#cspan,0,0,0");
                gridDtl.setInitWidths("100,100,100,100,100,100,100,100,100,100");
                gridDtl.setColAlign("center,center,center,center,center,center,center,right,right,right");
                gridDtl.setColTypes("ro,ro,ro,ro,ro,ro,ro,ron,ron,ron");
                gridDtl.setColSorting("str,str,str,str,str,str,str,int,int,int");
                gridDtl.init();
                //calRangeDate
                        ...
                        <div class="col-sm-8 col-md-8">
                            ...
                            <div class="form-group form-group-sm">
                                <label class=" col-sm-2 col-md-2 control-label" for="textinput">
                                    계정과목 </label>
                                <div class="col-sm-2 col-md-2">
                                  <input type="text" class="form-control input-xs" name="" id="" value="" ondblclick="fn_popup_acc()">
                                </div>
                            </div>
						</div>
                    </div>
