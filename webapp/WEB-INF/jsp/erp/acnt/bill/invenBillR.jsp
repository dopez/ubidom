    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                Ubi.setContainer(1, [1,8,9], "1C"); //재고자산명세서
                ...
                gridMain.setHeader("No,코드,계정,세목,전기이월,당기증가,당기감소,기말잔액");
                gridMain.attachFooter(",총계,#cspan,#cspan,0,0,0,0");
                gridMain.setInitWidths("100,100,100,100,100,100,100,100");
                gridMain.setColAlign("center,center,center,center,right,right,right,right");
                gridMain.setColTypes("ron,ro,ro,ro,ron,ron,ron,ron");
                gridMain.setColSorting("int,str,str,str,int,int,int,int");
                gridMain.init();
