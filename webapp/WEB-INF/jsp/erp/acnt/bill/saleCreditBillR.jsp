    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                Ubi.setContainer(1, [1,8,9], "1C"); //매출채권총괄표
                ...
                gridMain.setColAlign("center,center,center,right,right,right,right,right,right");
                gridMain.setColTypes("ron,ro,ro,ron,ron,ron,ron,ron,ron");
                gridMain.setColSorting("int,str,str,int,int,int,int,int,int");
                gridMain.init();
