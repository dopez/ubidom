    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                Ubi.setContainer(1, [1,8,9], "2E"); //매입처별계산서집계표
                ...
                <form class="form-horizontal" style="padding-top: 10px; padding-bottom: 5px; margin: 0px;" id="frmSearch">
                   <div class="form-group form-group-sm">
                       <table class="table table-bordered table-condensed">
                       	<thead>
                       		<tr class="active">
                       			<th colspan="2" class="col-sm-4 col-md-4">구분</th>
                       			<th class="col-sm-2 col-md-2">매입처수</th>
                       			<th class="col-sm-2 col-md-2">매수</th>
                       			<th class="col-sm-2 col-md-2">공급가액</th>
                       			<th class="col-sm-2 col-md-2">세액</th>
                       		</tr>
                       	</thead>
                       	<tbody>
                       		<tr>
