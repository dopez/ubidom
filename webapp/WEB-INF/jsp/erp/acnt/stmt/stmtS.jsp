    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                Ubi.setContainer(3, [1, 2, 3, 4, 5, 6, 7 ,9], "3E"); //전표등록(기본)
                ...
                gridDtl.setColAlign("center,center,center,right,right,left,center,center,center,center,center,center,center");
                gridDtl.setColTypes("ron,ro,ed,edn,edn,ed,ed,edn,dhxCalendarA,ed,coro,coro,coro");
                gridDtl.setColSorting("int,str,str,int,int,str,str,int,date,str,str,str,str");
                gridDtl.init();
                //setDate//
