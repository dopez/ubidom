...
$(document).ready(function(){
	...
	gridMain.setHeader("No,입고일자,입고자,품목코드,품명,포장,단위,입고위치,입고수량",null,
			["text-align:center;","text-align:center;","text-align:center;","text-align:center;","text-align:center;",
			 "text-align:center;","text-align:center;","text-align:center;","text-align:center;"]);
	gridMain.setInitWidths("100,100,100,100,100,100,100,100,100");
	gridMain.setColAlign("center,center,left,left,left,left,left,left,right");
	gridMain.setColTypes("ron,ro,ro,ro,ro,ro,ro,ro,ron");
	gridMain.setColSorting("int,date,str,str,str,str,str,str,int");
