...
$(document).ready(function(){
    ...
    gridMain.addHeader({name:"등록자",   colId:"inputName",   width:"80",  align:"left",   type:"ro"});
    ...
    gridMain.addHeader({name:"입고수량", colId:"qty",         width:"80",  align:"right",  type:"ro"});
    gridMain.addHeader({name:"단가",     colId:"cost",        width:"80",  align:"right",  type:"ro"});
    gridMain.addHeader({name:"금액",     colId:"amt",         width:"80",  align:"right",  type:"ro"});
    ...
    gridMain.init();
    gridMain.cs_setColumnHidden(["inputEmp","custCode","setSeq","setNo","compId","orderKey"]);
