...
$(document).ready(function(){
	...
	gridMain.setHeader("No,일자,부서,직위,성명,퇴근시간,연장근무시간",null,
			          ["text-align:center;","text-align:center;","text-align:center;","text-align:center;","text-align:center;",
			           "text-align:center;","text-align:center;"]);
	gridMain.setInitWidths("100,100,100,100,100,100,100");
	gridMain.setColAlign("center,center,left,left,left,center,right");
	gridMain.setColTypes("ron,ro,ro,ro,ro,ro,ro");
	gridMain.setColSorting("int,date,str,Str,Str,date,right");
	gridMain.init();		
