		  ...
		  <div class="col-sm-8 col-md-8">
			...
			<div class="col-sm-3 col-md-3 col-sm-offset-1 col-md-offset-1">
			  <div class="col-sm-6 col-md-6">
			    <input type="button" name="diliS" id="diliS" value="근태자료생성" class="form-control input-xs">
			  </div>
			  <div class="col-sm-6 col-md-6">
			    <input type="button" name="addS" id="addS" value="추가생성" class="form-control input-xs">
			  </div>
			</div>
		  </div>
	  </div>
