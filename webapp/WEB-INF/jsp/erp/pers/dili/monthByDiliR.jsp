...
$(document).ready(function(){
    ...
    gridMain.addHeader({name:"부서",         colId:"postName", 	 width:"4", align:"left",   type:"ro"});
    gridMain.addHeader({name:"직위",         colId:"jikweeName", width:"4", align:"left",   type:"ro"});
    gridMain.addHeader({name:"사번",         colId:"empNo", 	 width:"4", align:"left",   type:"ro"});
    gridMain.addHeader({name:"성명",         colId:"korName", 	 width:"4", align:"left",   type:"ro"});
    gridMain.addHeader({name:"근무일수",     colId:"workDay", 	 width:"4", align:"right",  type:"ro"});
    gridMain.addHeader({name:"근무시간",     colId:"workTime", 	 width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"연장시간",     colId:"overTime", 	 width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"야근시간",     colId:"nightTime",  width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"특근시간",     colId:"holiTime", 	 width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"특근연장시간", colId:"holiOver", 	 width:"6", align:"right",  type:"ron"});
    gridMain.addHeader({name:"주휴일수",     colId:"weekHoliy",  width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"지각시간",     colId:"lateTime", 	 width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"조퇴시간",     colId:"earlyTime",  width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"외출시간",     colId:"partTime", 	 width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"결근",         colId:"absence", 	 width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"무단결근",     colId:"awol", 	     width:"4", align:"right",  type:"ron"});
    gridMain.addHeader({name:"연차휴가",     colId:"yuncha", 	 width:"4", align:"right",  type:"ron"});
