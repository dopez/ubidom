...
$(document).ready(function(){
	...
	gridDtl.addHeader({name:"급여구분",   colId:"payGbn",   width:"7",  align:"left",   type:"combo"});
	gridDtl.addHeader({name:"근무구분",   colId:"serveGbn", width:"7",  align:"left",   type:"combo"});
	gridDtl.addHeader({name:"발령구분",   colId:"balGbn",   width:"7",  align:"left",   type:"combo"});
	gridDtl.addHeader({name:"부서코드",   colId:"postCode", width:"7",  align:"left",   type:"ro"});
	gridDtl.addHeader({name:"발령부서",   colId:"postName", width:"7",  align:"left",   type:"ro"});
	gridDtl.addHeader({name:"발령직군",   colId:"jikgun",   width:"7",  align:"left",   type:"combo"});
	gridDtl.addHeader({name:"발령직무",   colId:"jikmu",    width:"7",  align:"left",   type:"combo"});
	gridDtl.addHeader({name:"발령직위",   colId:"jikwee",   width:"7",  align:"left",   type:"combo"});
	gridDtl.addHeader({name:"발령직책",   colId:"jikchak",  width:"7",  align:"left",   type:"combo"});
	gridDtl.addHeader({name:"급여사업장", colId:"compId",   width:"7",  align:"left",   type:"combo"});
