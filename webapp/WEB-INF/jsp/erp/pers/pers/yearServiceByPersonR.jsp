...
$(document).ready(function(){
	...
	gridMst.addHeader({name:"부서명",   colId:"postName", width:"5", align:"left",   type:"ro"});
	gridMst.addHeader({name:"1년미만",  colId:"one",      width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"1~2",      colId:"two",      width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"2~3",      colId:"three",    width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"3~4",      colId:"four",     width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"4~5",      colId:"five",     width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"5~6",      colId:"six",      width:"5", align:"right",  type:"ro"});	
	gridMst.addHeader({name:"6~7",      colId:"seven",    width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"7~8",      colId:"eight",    width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"8~9",      colId:"nine",     width:"5", align:"right",  type:"ro"});	
	gridMst.addHeader({name:"9~10",     colId:"ten",      width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"10~15",    colId:"eleven",   width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"15~20",    colId:"twelve",   width:"5", align:"right",  type:"ro"});	
	gridMst.addHeader({name:"20~25",    colId:"thirteen", width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"25~30",    colId:"fourteen", width:"5", align:"right",  type:"ro"});
	gridMst.addHeader({name:"30년이상", colId:"fifteen",  width:"5", align:"right",  type:"ro"});	
	gridMst.addHeader({name:"전체 계",  colId:"tot",      width:"5", align:"right",  type:"ro"});
	...
	gridDtl.addHeader({name:"사원코드",   colId:"empNo",      width:"7", align:"left",   type:"ro"});
	gridDtl.addHeader({name:"사원명",     colId:"korName",    width:"7", align:"left",   type:"ro"});
	gridDtl.addHeader({name:"발령일자",   colId:"balDate",    width:"7", align:"center", type:"ro"});
	gridDtl.addHeader({name:"사업장구분", colId:"compId",     width:"7", align:"left",   type:"ro"});
	gridDtl.addHeader({name:"부서명",     colId:"postName",   width:"7", align:"left",   type:"ro"});
	gridDtl.addHeader({name:"직위",       colId:"jikweeName", width:"7", align:"left",   type:"ro"});
	gridDtl.addHeader({name:"근속년수",   colId:"yymm",       width:"7", align:"right",  type:"ro"});	
