...
$(document).ready(function(){
	...
	gridMst.setHeader("No,사번,성명,직위",null,
			         ["text-align:center;","text-align:center;","text-align:center;","text-align:center;"]);
	gridMst.setInitWidths("100,100,100,100");
	gridMst.setColAlign("center,left,left,left");
	gridMst.setColTypes("ron,ro,ro,ro");
	gridMst.setColSorting("int,str,str,str");
	gridMst.attachFooter(",,소계,0");
	gridMst.attachFooter(",,총합계,0");
	gridMst.init();	
	subLayout.cells("a").setWidth(403);
	
	gridDtl = subLayout.cells("b").attachGrid();
	gridDtl.setImagePath("/component/dhtmlxGrid/imgs/");
	gridDtl.setHeader("No,사번,성명,직위",null,
			         ["text-align:center;","text-align:center;","text-align:center;","text-align:center;"]);
	gridDtl.setInitWidths("100,100,100,100");
	gridDtl.setColAlign("center,left,left,left");
	gridDtl.setColTypes("ron,ro,ro,ro");
	gridDtl.setColSorting("int,str,str,str");
	gridDtl.attachFooter(",,소계,0");
	gridDtl.attachFooter(",,총합계,0");
	gridDtl.init();	
	 ...
	 <div class="row">
	    <div class="form-group form-group-sm">
		   <div class="col-sm-8 col-md-8">
			 ...
			 <div class="col-sm-3 col-md-3">
			   <div class="col-sm-6 col-md-6">
			      <input type="radio" name="empgubn" id="empgubn" value="인원별" checked="checked">인원별
			   </div>
			    <div class="col-sm-6 col-md-6">
			      <input type="radio" name="empgubn" id="empgubn" value="부서별">부서별
			   </div>
			 </div>
		  </div>
	   </div>
