...
$(document).ready(function(){
	...
	gridMain.setHeader("No,부서,직위,사번,성명,취득일자,증번호,보수월액(현),요율(현),산정금액(현),보수월액(전),요율(전),산정금액(전),금액차",null,
	...
	<div class="row">
	   <div class="form-group form-group-sm">
		  <div class="col-sm-8 col-md-8">
			...
			<div class="col-sm-2 col-md-2">
			  <input type="text" name="down" id="down" value="" class="form-control input-xs" disabled="disabled">
			</div>
			<label class="col-sm-1 col-md-1 control-label" for="textinput">
			 상한
			 </label>
			<div class="col-sm-2 col-md-2">
			  <input type="text" name="up" id="up" value="" class="form-control input-xs" disabled="disabled">
			</div>
			<label class="col-sm-2 col-md-2 control-label" for="textinput">
			 보험료율
			 </label>
