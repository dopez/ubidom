...
$(document).ready(function() {
	...
	gridMain.addHeader({name:"관리번호",colId:"logNum",width:"5",align:"center",type:"ro"});
	...
	gridMain.init();
	gridMain.cs_setColumnHidden(["compId","empNo","logDate","logSeq","logName","custCode","logKind","custKorName"]);
               //calRangeDate
...
function fn_search() {
    ...
    gfn_callAjaxForGrid(gridMain, obj, "/erp/sale/wlog/workLogAllR/gridMainSelRndt", subLayout.cells("a"), fn_gridMainSelCallbckFunc)
}
//excel
function fn_excel(){
