...
var uri = null;
    $(document).ready(function() {
		...
		gridMain.addHeader({name:"적용제품",colId:"targetItem",width:"200",align:"left",type:"ro"});
		...
		gridMain.addHeader({name:"변경",colId:"cDhAmt",width:"100",align:"center",type:"ro"});
		...
		gridMain.dxObj.setUserData("","@dueDate","format_date");
