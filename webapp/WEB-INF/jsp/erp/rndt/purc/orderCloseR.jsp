...
$(document).ready(function(){
	...
	gridMain.setHeader("마감일자,발주일자,공급업체,등록자,품목코드,품명,규격,단위,발주수량,입고수량,"+
			           "미입고수량",null,
	...
	gridMain.setInitWidths("100,100,100,100,100,100,100,100,100,100,"+
			               "100");
	gridMain.setColAlign("center,center,left,left,left,left,left,left,right,right,"+
			             "right");
	gridMain.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ron,ron,"+
			             "ron");
	gridMain.setColSorting("date,date,str,str,str,str,str,str,int,int,"+
			               "int");
