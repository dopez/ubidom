<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.*" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        $(document).ready(function(){
        	Ubi.setContainer(2, [1, 2, 3, 4, 5, 6], "2E"); //시험데이터등록1
            ...
            subLayout = Ubi.getSubLayout();
                ...
                gridDtl.setColAlign("center,center,center,center,center,center,center,center,center,center,center,center,center,center");
                gridDtl.setColTypes("ron,ed,ed,ed,edn,edn,edn,edn,ednedn,edn,edn,edn,edn,edn");
                gridDtl.setColSorting("int,str,str,str,int,int,int,int,int,int,int,int,int,int");
                gridDtl.init();
                //setDate//
