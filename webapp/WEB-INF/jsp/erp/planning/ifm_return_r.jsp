...
$( document ).ready(function() {
	...
	gridMain.setHeader("No,반품일자,공급업체,입고일자,품목,규격,단위,수량,단가,금액,반품사유", null, 
					[]);
	gridMain.setInitWidths("50,100,100,100,100,100,100,100,100,100,100");       
	gridMain.setColAlign("center,center,left,center,left,left,center,right,right,right,left");     
	gridMain.setColTypes("ron,ro,ro,ro,ed,ro,ro,ron,ron,ron,ro"); 
	gridMain.setColSorting("str,date,str,date,str,str,str,str,int,int,int,str");
	gridMain.init();
	  //calRangeDate
			...
			<div class="form-group form-group-sm">
				<div class="col-sm-12 col-md-7">
					<label class=" col-sm-2 col-md-2 control-label" for="textinput">
						공급업체 </label>
					<div class="col-sm-2 col-md-2">
						<input name="suplCompName" id="suplCompName" type="text" value=""
