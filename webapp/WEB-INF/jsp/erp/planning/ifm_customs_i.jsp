    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                ubi.init(1, [1, 2, 3, 4, 5, 6], "3U"); //통관등록

                o = ubi.getDataSet();

                //form//
                o.layout.cells("b").attachObject("bootContainer2");
                o.slayout.cells("a").attachObject("frmMainLeft");
                o.slayout.cells("a").setHeight(500);
                //grid	
                rightLayout = o.slayout.cells("b").attachLayout("2E");
                    ...
                    <div class="form-group form-group-sm">
                        <div class="col-sm-7 col-md-7">
                            ...
                            <div class="col-sm-8 col-md-8">
                                ...
                                <div class="col-sm-offset-1 col-md-offset-1 col-sm-4 col-md-2">
                    ...
                    <div class="row">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-2 col-md-2">
                                ...
                                <div class="col-sm-2 col-md-2">
                                    <span>
						       <img id="calpicker4" style="margin-top:1px;width:27px;height:27px; " class="calicon" src="/component/dhtmlxCalendar/imgs/calendar.gif" border="0">
						     </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-2 col-md-2">
                                ...
                                <div class="col-sm-2 col-md-2">
                                    <span>
						       <img id="calpicker5" style="margin-top:1px;width:27px;height:27px; " class="calicon" src="/component/dhtmlxCalendar/imgs/calendar.gif" border="0">
						     </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-2 col-md-2">
                                ...
                                <div class="col-sm-2 col-md-2">
                                    <span>
						       <img id="calpicker6" style="margin-top:1px;width:27px;height:27px; " class="calicon" src="/component/dhtmlxCalendar/imgs/calendar.gif" border="0">
						     </span>
                                </div>
                            </div>
                            <label class=" col-sm-2 col-md-2 control-label" for="textinput">
                    ...
                    <div class="row">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-2 col-md-2">
                                ...
                                <div class="col-sm-2 col-md-2">
                                    <span>
						       <img id="calpicker7" style="margin-top:1px;width:27px;height:27px; " class="calicon" src="/component/dhtmlxCalendar/imgs/calendar.gif" border="0">
						     </span>
                                </div>
                            </div>
                        </div>
