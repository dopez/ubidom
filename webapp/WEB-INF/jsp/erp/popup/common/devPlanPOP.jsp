...
$(document).ready(function(){
    ...
    gridMain.addHeader({name:"개발관리번호",   colId:"planNumb", 	width:"140", align:"center", type:"ro"});
 ...
 function fn_search(){
	 var params = "problemName=" + $("#problemName").val();
	  gfn_callAjaxForGrid(gridMain,params,"/erp/rndt/good/devMidS/selDevPlanPop",subLayout.cells("a"),fn_loadGridListCodeCB);
}
