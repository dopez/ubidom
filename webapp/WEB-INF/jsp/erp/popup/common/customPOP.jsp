...
$(document).ready(function(){
    ...
    gridMain.addHeader({name:"고객코드", colId:"custCode", 	width:"140", align:"center", type:"ro"});
	gridMain.addHeader({name:"고객명", 	 colId:"custKorName", 	width:"140", align:"center", type:"ro"});
