...
$(document).ready(function(){
	...
	gridMain.addHeader({name:"공급업체코드", colId:"custCode", 	width:"140", align:"center", type:"ro"});
	gridMain.addHeader({name:"공급업체명", colId:"custKorName", 	width:"140", align:"center", type:"ro"});
