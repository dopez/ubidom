...
$(document).ready(function(){
	...
	gridMain.setHeader("업체",null,
			["text-align:center;"]);
	gridMain.setInitWidths("300");
	gridMain.setColAlign("left");
	...
	<form class="form-horizontal" id="frmSearch" name="frmSearch" style="padding-top:10px;padding-bottom:5px;margin:0px;"> 
		<div class="form-group form-group-sm" style="width: 200px;">
		   <label class="col-xs-4 control-label" id="poplabel" for="textinput">
			...
			<div class="col-xs-6">
			  <input name="Buyer" id="Buyer" type="text" value="" placeholder="" class="form-control input-xs">
			</div>
		</div>  
  </form>
</div>