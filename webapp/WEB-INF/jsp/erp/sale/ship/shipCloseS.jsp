<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.*" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        $(document).ready(function() {
        	 ...
        	 Ubi.setContainer(3, [1, 2, 3, 4, 5, 6], "1C"); //출하마감
            ...
            gridMain = subLayout.cells("a").attachGrid();
                ...
                gridMain.setColAlign("center,center,center,left,left,left,center,center,right,center,right,right,right,right,right,center,center");
                gridMain.setColTypes("ron,ed,ed,ed,ed,ed,ed,ed,edn,dhxCalendar,edn,edn,edn,edn,edn,dhxCalendar,ch");
                gridMain.setColSorting("int,str,str,str,str,str,str,int,date,int,int,int,int,int,date,str");
                gridMain.init();
