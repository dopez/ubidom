    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                Ubi.setContainer(3, [1, 8, 9], "1C"); //시험검사의뢰조회
                ...
                gridMain.setColAlign("center,center,center,left,center,left,center,center,center,right,center,center,center,center,right,center,center,center");
                gridMain.setColTypes("ro,ro,ro,ro,ro,ro,coro,coro,ro,ro,ro,coro,ch,coro,coro,coro,ro,ro,ro,ro");
                gridMain.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str");
                gridMain.init();
                //calRangeDate
                    ...
                    <div class="row">
                        <div class="form-group form-group-sm">
                            <div class="col-sm-7 col-md-7">
                                ...
                                <div class="col-sm-2 col-md-2">
                                    <input name="rqstComp" id="rqstComp" type="text" value="" placeholder="" class="form-control input-xs">
                                </div>
                            </div>
                        </div>
                    </div>
