...
function doOnRowDbClicked(rId,cInd){
	...
	if(cFlag){
		...
		mainTabbar.tabs(preId).attachURL("/"+uri+".do",false,{planYear:dateValue,setNumb:seqValue,equiCode:equiCodeVal});	
	}
};
	   ...
	   <div class="row">
		   <div class="form-group form-group-sm">
			  <div class="col-sm-8 col-md-8">
				...
				<div class="col-sm-2 col-md-2">
				  <input name="equiCode" id="equiCode" type="text" value=""class="form-control input-xs" >
				</div>
			  </div>
		  </div>
	   </div>      
