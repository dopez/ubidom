...
$(document).ready(function(){
	...
	gridMain.setHeader("No,생산일자,요청부서,담당,고객,납기일자,모재코드,모재명,포장,단위",null,
			          ["text-align:center;","text-align:center;","text-align:center;","text-align:center;","text-align:center;",
			           "text-align:center;","text-align:center;","text-align:center;","text-align:center;","text-align:center;"]);
	gridMain.setInitWidths("100,100,100,100,100,100,100,100,100,100");
	gridMain.setColAlign("center,center,left,left,left,center,left,left,left,left");
	gridMain.setColTypes("ron,ro,ro,ro,ro,ro,ro,ro,ro,ro");
	gridMain.setColSorting("int,date,str,str,str,date,str,str,str,str");
	gridMain.init();	
